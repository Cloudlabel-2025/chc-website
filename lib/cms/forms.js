 ...
 * Public form handlers (contact, give-one-hour, newsletter) write to this
 ...
 *
 * @param {{ formType: 'CONTACT'|'GIVE_ONE_HOUR'|'NEWSLETTER', data: object, ipAddress?: string }} params
 */
export async function recordSubmission({ formType, data, ipAddress }) {
