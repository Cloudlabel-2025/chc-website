...
export const SITE_TEMPLATES = [
  ...
  },
  {
    ...
    content: { version: 1, sections: [
      ...
      section('serviceCarouselItem', [], serviceItems()),
      section('productisedService', [], [
  ...
  },
  {
    ...
    content: { version: 1, sections: [
      ...
      section('serviceSlide', [], serviceItems()),
  ...
  },
  {
    ...
    content: { version: 1, sections: [
      ...
      section('teamMember', [], [
        { key: 'person-1', fields: [image('photo', '/images/healthcheck.jpg'), text('name', 'Team member'), text('role', 'Role'), text('bio', 'Add a short professional biography.')] },
        { key: 'person-2', fields: [image('photo', '/images/oracle-tech-pod.jpg'), text('name', 'Team member'), text('role', 'Role'), text('bio', 'Add a short professional biography.')] },
      ]),
    ] },
  },
  {
    ...
    content: { version: 1, sections: [
      standardHero(),
      section('processSteps1', [], [{ key: 'step-1', fields: [text('number', '01'), text('title', 'Discover'), text('description', 'Describe the first delivery step.')] }]),
      section('processSteps2', [], [{ key: 'step-2', fields: [text('number', '02'), text('title', 'Deliver'), text('description', 'Describe the next delivery step.')] }]),
      section('faqItem', [], [{ key: 'faq-1', fields: [text('question', 'Frequently asked question'), text('answer', 'Add a clear, helpful answer.')] }]),
    ] },
  },
  {
