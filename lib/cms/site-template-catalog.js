...
export const SITE_TEMPLATES = [
  ...
  },
  {
    ...
    content: { version: 1, sections: [
      ...
      section('serviceSlide', [text('sectionHeading', 'Experienced services')], serviceItems()),
  ...
  },
  {
    ...
    content: { version: 1, sections: [
      ...
      section('faqItem', [text('sectionHeading', 'Frequently asked questions')], [{ key: 'faq-1', fields: [text('question', 'Frequently asked question'), text('answer', 'Add a clear, helpful answer.')] }]),
    ] },
  },
  {
