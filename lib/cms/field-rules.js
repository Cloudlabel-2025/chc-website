...
export const fieldRules = {
  ...
  home: {
    ...
    intro: {
      ...
      buttonLabel: { type: 'text', editClass: 'B', label: 'Primary button label', required: false, maxLength: 50 },
      buttonHref: { type: 'url', editClass: 'B', label: 'Primary button URL', required: false, maxLength: 200 },
      linkLabel: { type: 'text', editClass: 'B', label: 'Secondary link label', required: false, maxLength: 50 },
      linkHref: { type: 'url', editClass: 'B', label: 'Secondary link URL', required: false, maxLength: 200 },
      note: { type: 'text', editClass: 'B', label: 'Supporting note', required: false, maxLength: 160 },
    },
    whatWeDo: {
      sectionHeading: {
  ...
  contact: {
    ...
    mapLat: {
      ...
      required: false, maxLength: 20,
      note: 'Center coordinate for the contact page Google Map',
    },
    mapLng: {
