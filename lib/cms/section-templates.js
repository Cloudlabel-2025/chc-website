...
const CORE_SECTION_TEMPLATES = [
  ...
  },
  {
    ...
    name: 'Oracle Delivery Capacity',
    category: 'Oracle HCM',
    description: 'Heading and supporting copy for the Oracle delivery-capacity carousel.',
    defaultBlocks: [
  ...
  },
  {
    ...
    defaultBlocks: [{ fieldKey: 'sectionHeading', blockType: 'TEXT', textValue: 'Oracle Delivery Services' }],
    defaultItems: [
...
const COMPLETE_SECTION_TEMPLATES = [
  ...
  { key: 'serviceSlide', name: 'Service Slides', category: 'Carousels', description: 'A horizontal services carousel.', defaultBlocks: [text('sectionHeading', 'Experienced services')], defaultItems: [{ key: 'service-1', fields: [image('image', '/images/config.png'), text('title', 'Service title'), text('description', 'Describe this service and its value.'), url('href', '/services')] }] },
  ...
  { key: 'faqItem', name: 'FAQ Cards', category: 'Content', description: 'Frequently asked questions.', defaultBlocks: [text('sectionHeading', 'Frequently asked questions')], defaultItems: [{ key: 'faq-1', fields: [text('question', 'Frequently asked question'), text('answer', 'Add a clear, helpful answer.')] }] },
  ...
  { key: 'newsletterForm', name: 'Newsletter Form Copy', category: 'Forms', description: 'Editable newsletter signup copy.', defaultBlocks: [text('heading', 'Stay connected'), text('placeholder', 'Your email address'), text('successMessage', 'Thank you for subscribing.')] },
